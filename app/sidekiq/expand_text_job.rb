class ExpandTextJob
  ...
  def call_openai(page:)
    content = <<~MARKDOWN
      <p>あなたはWikiを動的に生成するLLMです。与えられたテキストに情報を追加して長くしてください。もし見出しが含まれていたらそれについての情報を増やしてください。その記事がより専門的であればあるほど、より具体的な例を含んでいればいるほど、より歴史的な背景を含んでいればいるほど、記事としての価値は高まります。</p>
